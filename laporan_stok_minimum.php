...
foreach ($data as $row) {
    ...
    // Path gambar
    if (!empty($row['gambar']) && file_exists('produk_img/' . $row['gambar'])) {
    $gambarHtml = '<img src="produk_img/' . $row['gambar'] . '">';
} else {
    $gambarHtml = '-';
}
