...
$ambil = mysqli_query($conn, "SELECT * FROM users WHERE id='$id'");
...
<head>
    ...
    <title>Kategori Produk - BarangEndy</title>
...
<body>
    ...
    <div class="col-12">
        ...
        <select class="form-control" name="is_active">
            ...
            <option value="0" <?php if ($data['is_active'] == 0) echo 'selected'; ?>>Nonaktif</option>
        </select>
    </div>
